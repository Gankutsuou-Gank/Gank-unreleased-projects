...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TextToSpeech", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TextToSpeech", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TextToSpeech";
		app.meta["name"] = "TextToSpeech";
